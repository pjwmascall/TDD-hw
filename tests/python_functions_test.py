...
class TestPythonFunctionPractice(unittest.TestCase):
  ...
  def test_reverse_string(self):
    #add test code here
    reversed_string = reverse_string( "my string" )
    self.assertEqual( "gnirts ym", reversed_string )

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius(self):
    #add test code here
    fahrenheit_in_celcius = fahrenheit_to_celcius( 400 )
    self.assertEqual( 204, fahrenheit_in_celcius )
